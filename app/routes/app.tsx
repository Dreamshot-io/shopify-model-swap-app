...
import { Link, Outlet, useLoaderData, useRouteError, isRouteErrorResponse, useNavigation } from '@remix-run/react';
...
export default function App() {
	...
	// Show/hide App Bridge loading indicator based on navigation state
	// Covers both "loading" (link clicks) and "submitting" (form posts)
	useEffect(() => {
