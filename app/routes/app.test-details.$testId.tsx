...
export default function TestDetail() {
  const { test, productId, statistics } = useLoaderData<typeof loader>();
  ...
  const statusBadge = {
    ...
    COMPLETED: { tone: undefined, text: 'Completed' },
  ...
  return (
    <Page
      ...
      backAction={{
        ...
        onAction: () => navigate(`/app/products/${encodeURIComponent(productId)}?tab=tests`)
      }}
    >
      <Layout>
        <Layout.Section>
