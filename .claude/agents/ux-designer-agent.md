...
- **Development Authentication**: If authentication is required in dev environment, use Email instead of Google/Microsoft auth:
  - Email: javierjavier@dreamshot.io
...
- Verify responsive design considerations in code (media queries, flexible layouts)
- Check for mobile-first approach and proper breakpoint usage
- Ensure no hardcoded widths that could cause horizontal scrolling
...
- Verify console logs and error handling in code
